...
$(function () {
    ...
    var ajaxCall = {
        login: function (username, password) {
            ...
            return $.post(DOMAIN + /login/, postdata);
        },
...
*/
    ...
    function App() {
        ...
        self.feature_posts_0_pic=ko.observable();
        self.feature_posts_1_pic=ko.observable();
        self.feature_posts_2_pic=ko.observable();
        self.feature_posts_3_pic=ko.observable();
        self.feature_posts_4_pic=ko.observable();
        self.feature_img_url_0 = ko.computed(function() {
            return "url( media/" + self.feature_posts_0_pic() + ")";
        });
        self.feature_img_url_1 = ko.computed(function() {
            return "url( media/" + self.feature_posts_1_pic() + ")";
        });
        self.feature_img_url_2 = ko.computed(function() {
            return "url( media/" + self.feature_posts_2_pic() + ")";
        });
        self.feature_img_url_3 = ko.computed(function() {
            return "url( media/" + self.feature_posts_3_pic() + ")";
        });
        self.feature_img_url_4 = ko.computed(function() {
            return "url( media/" + self.feature_posts_4_pic() + ")";
        });
        ...
        self.get_feature_post= function(){
                ajaxCall.get_feature_post().done(function (raw) {
                    ...
                    self.feature_posts_0_pic(raw[0].room_pic1);                    
                    self.feature_posts_1_pic(raw[1].room_pic1);                    
                    self.feature_posts_2_pic(raw[2].room_pic1);                    
                    self.feature_posts_3_pic(raw[3].room_pic1);                    
                    self.feature_posts_4_pic(raw[4].room_pic1);                    
                    console.log(self.feature_posts_0());
                });            
        };
...
//            self.viewChange('main');
        //self.viewChange('search');
            ...
            // Client-side routes    
    Sammy(function() {
        this.get('/index.html#search', function() {self.viewChange('search');});  
        this.get('/index.html#search_zip=:zip', function() {self.viewChange('search',{search_zip: this.params.zip});});
        this.get('/index.html#post', function() {self.viewChange('post');});
        this.get('/index.html#login', function() {self.viewChange('login');});
        this.get('/index.html#event/:id', function() {self.viewChange('event', {id: this.params.id});});
        this.get('/index.html#event_detail/:id', function() {self.viewChange('event', {id: this.params.id});});        
        this.get('/index.html#create_account', function() {self.viewChange('create_account');});
        this.get('/index.html#notice_page', function() {self.viewChange('notice_page');});
        this.get('/index.html#conversation_page=:post_id=:asker_id', function() {self.viewChange('conversation_page',{post_id: this.params.post_id, asker_id: this.params.asker_id});});
        this.get('/index.html#conversation_page', function() {self.viewChange('conversation_page');});        
        this.get('/index.html#login', function() {self.viewChange('main');});
        this.get('/index.html', function() { self.viewChange('main'); });
        this.get('/polls/add_pic/', function(form) { self.defaultCheckFormSubmission(form); });
        this.get('/login/login/', function() { return (false); });
        this.get('', function() { self.viewChange('main'); });
        //this._checkFormSubmission = function(form) {
        //    return (false);
        //};    
/*    this.defaultCheckFormSubmission = this._checkFormSubmission; 
    this._checkFormSubmission = function (form) { 
      var $form, path, verb,enctype; 
      $form = $(form); 
